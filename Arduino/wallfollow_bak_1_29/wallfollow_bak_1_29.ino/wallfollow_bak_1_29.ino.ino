...
Sensor sensorFront(13,8,A0,0);//0 is useing analog mode! Sensor(int URECHO,int URTRIG,uint8_t sensorPin,int Mode);
//Sensor1 sensorRear(11,12,A1,1);//0 is useing analog mode! Sensor(int URECHO,int URTRIG,uint8_t sensorPin,int Mode);
// # Connection:
